  ...
  return (
    <header className="sticky top-0 z-50 bg-white/80 dark:bg-gray-900/80
      ...
      <nav className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        >
          <span className="block w-6 h-0.5 bg-gray-600 dark:bg-gray-300 mb-1.5" />
          <span className="block w-6 h-0.5 bg-gray-600 dark:bg-gray-300 mb-1.5" />
      ...
      {/* Mobil menu */}
      {menuOpen && (
        <ul className="md:hidden border-t border-gray-200 dark:border-gray-700
          ...
          {navLinks.map(link => (
            <li key={link.href}>
              <a
                ...
                className="block py-3 text-gray-600 dark:text-gray-300
