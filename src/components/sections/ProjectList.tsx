          ...
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200
            ...
            <button
              ...
              className="text-sm text-red-600 dark:text-red-400 underline mt-2
                hover:text-red-800 dark:hover:text-red-200 transition-colors"
            >
              Tekrar dene
            </button>
          </div>
            ...
            >
              ...
              <div className="p-4">
                <div className="flex items-start justify-between mb-2">
                  ...
                  {project.featured && (
                    <span className="bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800
                      dark:text-yellow-300 text-xs px-2 py-0.5 rounded-full shrink-0 ml-2">
                      Öne Çıkan
                    </span>
                  )}
                </div>
                ...
                <div className="flex flex-wrap gap-1 mb-3">
                  {project.tech.map(t => (
                    <span
                      key={t}
                      className="bg-blue-100 dark:bg-blue-900/40 text-blue-800
                        dark:text-blue-200 text-xs px-2 py-0.5 rounded-full"
                    >
                      {t}
                    </span>
                  ))}
